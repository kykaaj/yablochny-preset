...
function updateSectionCss() {
    ...
    for (const headerId of _ypSectionMap.headerIds) {
        ...
        // Headers stay natively left-aligned so they don't break
...
function injectDynamicStyles() {
    ...
    console.log("[Yablochny] injectDynamicStyles called, existing tag:", !!document.getElementById(styleId));
    ...
    css += ".yp-overlay-gold { box-shadow: 0 0 15px 5px rgba(232, 228, 201, 0.4), inset 0 0 20px 2px rgba(232, 228, 201, 0.1); background-color: rgba(232, 228, 201, 0.05); } ";
